...
import com.lucena.user.business.dto.EnderecoDTO;
import com.lucena.user.business.dto.TelefoneDTO;
import com.lucena.user.business.dto.UsuarioDTO;
import com.lucena.user.infrastructure.entity.Endereco;
import com.lucena.user.infrastructure.entity.Telefone;
...
import com.lucena.user.infrastructure.repository.EnderecoRepository;
import com.lucena.user.infrastructure.repository.TelefoneRepository;
...
public class UsuarioService {
    ...
    public EnderecoDTO atualizaEndereco(Long idEnderco, EnderecoDTO enderecoDTO){

        Endereco entity = enderecoRepository.findById(idEnderco).orElseThrow(() ->
                new ResourceNotFoundException("ID não enontrado "+idEnderco));
